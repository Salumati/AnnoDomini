...
libraryDependencies += "com.typesafe.slick" %% "slick" % "2.12.15" //).cross(CrossVersion.for3Use2_13)
libraryDependencies += "com.typesafe.slick" %% "slick-hikaricp" % "2.12.15" //).cross(CrossVersion.for3Use2_13)
